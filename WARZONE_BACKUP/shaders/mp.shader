...
{
	qer_editorimage	gfx/effects/mp_r_forcefield_d
	surfaceparm	noimpact
	surfaceparm	trans
	nopicmip
	q3map_nolightmap
	cull	twosided
    {
        map gfx/effects/mp_r_forcefield_d
        blendFunc GL_ONE GL_ONE
        rgbGen wave sin 0.65 0.35 0 0.2
        tcMod scroll -1 2
    }
    {
        map gfx/effects/mp_r_forcefield_d1
        blendFunc GL_ONE GL_ONE
        tcMod scroll 2 1
    }
    {
        map gfx/misc/redstatic
        blendFunc GL_ONE GL_ONE
...
gfx/mp_automap/mpauto_frame_bottom
{
    {
        map gfx/mp_automap/mpauto_frame_bottom
        blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
    }
}

gfx/mp_automap/mpauto_frame_top
{
    {
        map gfx/mp_automap/mpauto_frame_top
        blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
    }
}

gfx/mp_automap/mpauto_frame_left
{
    {
        map gfx/mp_automap/mpauto_frame_left
        blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
    }
}
...
{
    {
        map gfx/mp_automap/mpauto_frame_right
        blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
    }
}
