...
#ifdef ME
	Sys_PrintHeading("--- Node Portalization ---\n");
...
qboolean FloodEntities (tree_t *tree)
{
	...
	Sys_PrintHeading("--- FloodEntities ---\n");
	inside = false;
...
void MarkVisibleSides(tree_t *tree, int startbrush, int endbrush)
{
	...
	Sys_PrintHeading("--- MarkVisibleSides ---\n");
