...
textures/rooftop/light_trim3
{
    {
        map $lightmap
    }
    {
        map textures/rooftop/light_trim3
        blendFunc GL_DST_COLOR GL_ZERO
    }
    {
        map textures/rooftop/light_trim3_glw
        blendFunc GL_ONE GL_ONE
        glow
        rgbGen identity
    }
...
textures/rooftop/window_building_ground2
{
	q3map_material	SolidMetal
    {
        map $lightmap
    ...
    {
        map textures/rooftop/window_building_ground2
        blendFunc GL_DST_COLOR GL_ZERO
    }
}

textures/rooftop/window_building_ground
{
	q3map_material	SolidMetal
    {
        map $lightmap
    ...
    {
        map textures/rooftop/window_building_ground
        blendFunc GL_DST_COLOR GL_ZERO
    }
}

textures/rail/tower_light
{
	q3map_nolightmap
    {
        map textures/rail/tower_light
        blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
    }
}
...
textures/rail/windows7
{
	q3map_nolightmap
    {
        map textures/rail/windows7
        rgbGen identity
    }
    {
        map textures/rail/windows7_glow
        blendFunc GL_ONE GL_ONE
        glow
        rgbGen wave sawtooth 0 1 0 0.35
    }
    {
        map textures/rail/windows7_glowb
        blendFunc GL_ONE GL_ONE
        glow
...
textures/rail/windows_b_new
{
	qer_editorimage	textures/rail/windows_b
	q3map_nolightmap
    {
        map textures/rail/windows_b
        rgbGen identity
...
textures/rail/windows7_new
{
	qer_editorimage	textures/rail/windows7
	q3map_nolightmap
    {
        map textures/rail/windows7
        rgbGen identity
...
textures/rail/rail_console3
{
	qer_editorimage	textures/rail/rail_console3
    {
        map $lightmap
    }
    {
        map textures/rail/rail_console3
        blendFunc GL_DST_COLOR GL_ZERO
    }
    {
        map textures/rail/rail_console3_glow
        blendFunc GL_ONE GL_ONE
        glow
        rgbGen wave square 0 1 0 0.5
    }
...
textures/rail/base_bronze_dark_old
{
	q3map_material	HollowMetal
    {
        map $lightmap
    ...
    {
        map textures/rail/base_bronze_dark_old
        blendFunc GL_DST_COLOR GL_ZERO
    }
}

textures/rail/base_bronze_old
{
	q3map_material	HollowMetal
    {
        map $lightmap
    ...
    {
        map textures/rail/base_bronze_old
        blendFunc GL_DST_COLOR GL_ZERO
    }
}
...
textures/rail/trainend_basic
{
    ...
    {
        map textures/rail/trainend_basic
        blendFunc GL_DST_COLOR GL_ZERO
    }
}
