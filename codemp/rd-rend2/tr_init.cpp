...
void R_Register( void ) 
{
	...
	r_bloomPasses = ri->Cvar_Get( "r_bloomPasses", "4", CVAR_ARCHIVE );
	...
	r_volumelightExposure = ri->Cvar_Get( "r_volumelightExposure", "0.06", CVAR_ARCHIVE );
	r_volumelightDecay = ri->Cvar_Get( "r_volumelightDecay", "0.98", CVAR_ARCHIVE );
	r_volumelightDensity = ri->Cvar_Get( "r_volumelightDensity", "1.0", CVAR_ARCHIVE );
	r_volumelightWeight = ri->Cvar_Get( "r_volumelightWeight", "0.02", CVAR_ARCHIVE );
