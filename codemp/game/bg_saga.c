...
stringID_table_t WPTable[] =
{
	...
	//ENUM2STRING(WP_SHOCK_GRENADE),
	//ENUM2STRING(WP_PLASMA_GRENADE),
	///*ENUM2STRING(WP_SONIC_GRENADE),*/
	//ENUM2STRING(WP_THERMAL_GRENADE),
	//ENUM2STRING(WP_THERMAL_GREADE_OLD),
	//ENUM2STRING(WP_V_59_GRENADE),
