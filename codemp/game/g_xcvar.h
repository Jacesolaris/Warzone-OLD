...
XCVAR_DEF(d_saberAlwaysBoxTrace,		"1",			NULL,				CVAR_CHEAT,										qtrue)
XCVAR_DEF(d_saberBoxTraceSize,			"8",			NULL,				CVAR_CHEAT,										qtrue)
...
XCVAR_DEF( g_sniperdamage,				"0",			NULL,				CVAR_CHEAT,										qtrue )
