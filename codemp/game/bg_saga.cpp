...
stringID_table_t WPTable[] =
{
	...
	ENUM2STRING(WP_A280),
	ENUM2STRING(WP_DC15),
	ENUM2STRING(WP_WESTARM5),
	ENUM2STRING(WP_T21),
	ENUM2STRING(WP_EE3),
	ENUM2STRING(WP_DC_15S_CLONE_PISTOL),
	ENUM2STRING(WP_DLT_19),
	ENUM2STRING(WP_DC_15A_RIFLE),
	ENUM2STRING(WP_WESTER_PISTOL),
	ENUM2STRING(WP_ELG_3A),
	ENUM2STRING(WP_S5_PISTOL),
	ENUM2STRING(WP_Z6_BLASTER_CANON),
	ENUM2STRING(WP_HEAVY_BOWCASTER_SCOPE),
	ENUM2STRING(WP_WOOKIES_PISTOL),
	ENUM2STRING(WP_CLONE_BLASTER),
	ENUM2STRING(WP_DC15_EXT),
	ENUM2STRING(WP_E60_ROCKET_LAUNCHER),
	ENUM2STRING(WP_CW_ROCKET_LAUNCHER),
	ENUM2STRING(WP_TESTGUN),
	ENUM2STRING(WP_DC_17_CLONE_PISTOL),
	ENUM2STRING(WP_SPOTING_BLASTER),
	ENUM2STRING(WP_A200_ACP_BATTLERIFLE),
	ENUM2STRING(WP_A200_ACP_PISTOL),
	ENUM2STRING(WP_ACP_ARRAYGUN),
	ENUM2STRING(WP_ACP_SNIPER_RIFLE),
	ENUM2STRING(WP_ARC_CASTER_IMPERIAL),
	ENUM2STRING(WP_BOWCASTER_CLASSIC),
	ENUM2STRING(WP_HEAVY_SCOPE_BOWCASTER),
	ENUM2STRING(WP_BRYAR_CARBINE),
	ENUM2STRING(WP_BRYAR_RIFLE),
	ENUM2STRING(WP_BRYAR_RIFLE_SCOPE),
	ENUM2STRING(WP_PULSECANON),
	ENUM2STRING(WP_PROTON_CARBINE_RIFLE),
	ENUM2STRING(WP_DH_17_PISTOL),
	// START: Do not change anything between these 2 comments...
	...
	ENUM2STRING(WP_FRAG_GRENADE),
	ENUM2STRING(WP_FRAG_GRENADE_OLD),
	ENUM2STRING(WP_CYROBAN_GRENADE),
...
void BG_SiegeParseTeamFile(const char *filename)
{
	...
	if (BG_SiegeGetValueGroup(teamInfo, "Classes", teamInfo))
	{
		...
		{ //keep checking for group values named class# up to MAX_SIEGE_CLASSES until we can't find one.
			...
			success = (qboolean)BG_SiegeGetPairedValue(teamInfo, lookString, parseBuf);
