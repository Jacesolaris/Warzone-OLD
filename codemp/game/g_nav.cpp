...
void Svcmd_Nav_f( void )
{
	...
	if ( Q_stricmp( cmd, "show" ) == 0 )
	{
		...
		{
			NAVDEBUG_showNodes = (qboolean)!NAVDEBUG_showNodes;
		...
		{
			NAVDEBUG_showRadius = (qboolean)!NAVDEBUG_showRadius;
		}
		else if ( Q_stricmp( cmd, "edges" ) == 0 )
		{
			NAVDEBUG_showEdges = (qboolean)!NAVDEBUG_showEdges;
		}
		else if ( Q_stricmp( cmd, "testpath" ) == 0 )
		{
			NAVDEBUG_showTestPath = (qboolean)!NAVDEBUG_showTestPath;
		}
		else if ( Q_stricmp( cmd, "enemypath" ) == 0 )
		{
			NAVDEBUG_showEnemyPath = (qboolean)!NAVDEBUG_showEnemyPath;
		}
		else if ( Q_stricmp( cmd, "combatpoints" ) == 0 )
		{
			NAVDEBUG_showCombatPoints = (qboolean)!NAVDEBUG_showCombatPoints;
		}
		else if ( Q_stricmp( cmd, "navgoals" ) == 0 )
		{
			NAVDEBUG_showNavGoals = (qboolean)!NAVDEBUG_showNavGoals;
		}
		else if ( Q_stricmp( cmd, "collision" ) == 0 )
		{
			NAVDEBUG_showCollision = (qboolean)!NAVDEBUG_showCollision;
		}
	}
