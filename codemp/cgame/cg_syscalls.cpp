...
qboolean trap_R_InitWireframeAutomap(void) {
	return (qboolean)Q_syscall( CG_R_INITWIREFRAMEAUTO );
}
...
qboolean trap_GetDefaultState(int entityIndex, entityState_t *state ) {
	return (qboolean)Q_syscall( CG_GETDEFAULTSTATE, entityIndex, state );
}
...
qboolean trap_Key_IsDown( int keynum ) {
	return (qboolean)Q_syscall( CG_KEY_ISDOWN, keynum );
}
...
qboolean trap_GetEntityToken( char *buffer, int bufferSize ) {
	return (qboolean)Q_syscall( CG_GET_ENTITY_TOKEN, buffer, bufferSize );
}
qboolean trap_R_inPVS( const vec3_t p1, const vec3_t p2, byte *mask ) {
	return (qboolean)Q_syscall( CG_R_INPVS, p1, p2, mask );
}
...
qboolean trap_FX_PlayBoltedEffectID( int id, vec3_t org, void *ghoul2, const int boltNum, const int entNum, const int modelNum, int iLooptime, qboolean isRelative ) {
	return (qboolean)Q_syscall( CG_FX_PLAY_BOLTED_EFFECT_ID, id, org, ghoul2, boltNum, entNum, modelNum, iLooptime, isRelative );
}
...
qboolean trap_FX_FreeSystem( void ) {
	return (qboolean)Q_syscall( CG_FX_FREE_SYSTEM );
}
...
qboolean trap_SE_GetStringTextString(const char *text, char *buffer, int bufferLength) {
	return (qboolean)Q_syscall( CG_SP_GETSTRINGTEXTSTRING, text, buffer, bufferLength );
}
qboolean trap_ROFF_Clean( void ) {
	return (qboolean)Q_syscall( CG_ROFF_CLEAN );
}
...
qboolean trap_ROFF_Play( int entID, int roffID, qboolean doTranslation ) {
	return (qboolean)Q_syscall( CG_ROFF_PLAY, entID, roffID, doTranslation );
}
qboolean trap_ROFF_Purge_Ent( int entID ) {
	return (qboolean)Q_syscall( CG_ROFF_PURGE_ENT, entID );
}
...
qboolean trap_G2API_SetSkin(void *ghoul2, int modelIndex, qhandle_t customSkin, qhandle_t renderSkin) {
	return (qboolean)Q_syscall(CG_G2_SETSKIN, ghoul2, modelIndex, customSkin, renderSkin);
}
...
qboolean trap_G2API_SetBoneAngles(void *ghoul2, int modelIndex, const char *boneName, const vec3_t angles, const int flags, const int up, const int right, const int forward, qhandle_t *modelList, int blendTime , int currentTime ) {
	return (qboolean)(Q_syscall(CG_G2_ANGLEOVERRIDE, ghoul2, modelIndex, boneName, angles, flags, up, right, forward, modelList, blendTime, currentTime));
}
qboolean trap_G2API_SetBoneAnim(void *ghoul2, const int modelIndex, const char *boneName, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame , const int blendTime ) {
	return (qboolean)Q_syscall(CG_G2_PLAYANIM, ghoul2, modelIndex, boneName, startFrame, endFrame, flags, PASSFLOAT(animSpeed), currentTime, PASSFLOAT(setFrame), blendTime);
}
qboolean trap_G2API_GetBoneAnim(void *ghoul2, const char *boneName, const int currentTime, float *currentFrame, int *startFrame, int *endFrame, int *flags, float *animSpeed, int *modelList, const int modelIndex) {
	return (qboolean)Q_syscall(CG_G2_GETBONEANIM, ghoul2, boneName, currentTime, currentFrame, startFrame, endFrame, flags, animSpeed, modelList, modelIndex);
}
qboolean trap_G2API_GetBoneFrame(void *ghoul2, const char *boneName, const int currentTime, float *currentFrame, int *modelList, const int modelIndex) {
	return (qboolean)Q_syscall(CG_G2_GETBONEFRAME, ghoul2, boneName, currentTime, currentFrame, modelList, modelIndex);
}
...
qboolean trap_G2API_HasGhoul2ModelOnIndex(void *ghlInfo, int modelIndex) {
	return (qboolean)Q_syscall(CG_G2_HASGHOUL2MODELONINDEX, ghlInfo, modelIndex);
}
qboolean trap_G2API_RemoveGhoul2Model(void *ghlInfo, int modelIndex) {
	return (qboolean)Q_syscall(CG_G2_REMOVEGHOUL2MODEL, ghlInfo, modelIndex);
}
qboolean trap_G2API_SkinlessModel(void *ghlInfo, int modelIndex) {
	return (qboolean)Q_syscall(CG_G2_SKINLESSMODEL, ghlInfo, modelIndex);
}
...
qboolean trap_G2API_AttachEnt(int *boltInfo, void *ghlInfoTo, int toBoltIndex, int entNum, int toModelNum) {
	return (qboolean)Q_syscall(CG_G2_ATTACHENT, boltInfo, ghlInfoTo, toBoltIndex, entNum, toModelNum);
}
void trap_G2API_SetBoltInfo(void *ghoul2, int modelIndex, int boltInfo) {
	Q_syscall(CG_G2_SETBOLTON, ghoul2, modelIndex, boltInfo);
}
qboolean trap_G2API_SetRootSurface(void *ghoul2, const int modelIndex, const char *surfaceName) {
	return (qboolean)Q_syscall(CG_G2_SETROOTSURFACE, ghoul2, modelIndex, surfaceName);
}
qboolean trap_G2API_SetSurfaceOnOff(void *ghoul2, const char *surfaceName, const int flags) {
	return (qboolean)Q_syscall(CG_G2_SETSURFACEONOFF, ghoul2, surfaceName, flags);
}
qboolean trap_G2API_SetNewOrigin(void *ghoul2, const int boltIndex) {
	return (qboolean)Q_syscall(CG_G2_SETNEWORIGIN, ghoul2, boltIndex);
}
qboolean trap_G2API_DoesBoneExist(void *ghoul2, int modelIndex, const char *boneName) {
	return (qboolean)Q_syscall(CG_G2_DOESBONEEXIST, ghoul2, modelIndex, boneName);
}
...
qboolean trap_G2API_RagPCJConstraint(void *ghoul2, const char *boneName, vec3_t min, vec3_t max) {
	return (qboolean)Q_syscall(CG_G2_RAGPCJCONSTRAINT, ghoul2, boneName, min, max);
}
qboolean trap_G2API_RagPCJGradientSpeed(void *ghoul2, const char *boneName, const float speed) {
	return (qboolean)Q_syscall(CG_G2_RAGPCJGRADIENTSPEED, ghoul2, boneName, PASSFLOAT(speed));
}
qboolean trap_G2API_RagEffectorGoal(void *ghoul2, const char *boneName, vec3_t pos) {
	return (qboolean)Q_syscall(CG_G2_RAGEFFECTORGOAL, ghoul2, boneName, pos);
}
qboolean trap_G2API_GetRagBonePos(void *ghoul2, const char *boneName, vec3_t pos, vec3_t entAngles, vec3_t entPos, vec3_t entScale) {
	return (qboolean)Q_syscall(CG_G2_GETRAGBONEPOS, ghoul2, boneName, pos, entAngles, entPos, entScale);
}
qboolean trap_G2API_RagEffectorKick(void *ghoul2, const char *boneName, vec3_t velocity) {
	return (qboolean)Q_syscall(CG_G2_RAGEFFECTORKICK, ghoul2, boneName, velocity);
}
qboolean trap_G2API_RagForceSolve(void *ghoul2, qboolean force) {
	return (qboolean)Q_syscall(CG_G2_RAGFORCESOLVE, ghoul2, force);
}
qboolean trap_G2API_SetBoneIKState(void *ghoul2, int time, const char *boneName, int ikState, sharedSetBoneIKStateParams_t *params) {
	return (qboolean)Q_syscall(CG_G2_SETBONEIKSTATE, ghoul2, time, boneName, ikState, params);
}
qboolean trap_G2API_IKMove(void *ghoul2, int time, sharedIKMoveParams_t *params) {
	return (qboolean)Q_syscall(CG_G2_IKMOVE, ghoul2, time, params);
}
qboolean trap_G2API_RemoveBone(void *ghoul2, const char *boneName, int modelIndex) {
	return (qboolean)Q_syscall(CG_G2_REMOVEBONE, ghoul2, boneName, modelIndex);
}
...
qboolean trap_G2API_OverrideServer(void *serverInstance) {
	return(qboolean)Q_syscall(CG_G2_OVERRIDESERVER, serverInstance);
}
...
void QDECL CG_Printf( const char *msg, ... ) {
	...
	if ( ret == -1 )
		trap->Print( "CG_Printf: overflow of 4096 bytes buffer\n" );
	else
		trap->Print( text );
}
