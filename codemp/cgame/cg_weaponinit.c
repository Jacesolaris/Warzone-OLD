...
//	strcat( path, "_flash.md3" );
	...
	case WP_E60_ROCKET_LAUNCHER:
		weaponInfo->item->classname = "PLX-1";
		...
		weaponInfo->missileModel =  trap->R_RegisterModel("models/weapons2/cw_launcher/projectile.md3");
		...
		weaponInfo->altMissileModel =  trap->R_RegisterModel("models/weapons2/cw_launcher/projectile.md3");
