...
XCVAR_DEF(cg_foliageGrassRangeMult,					"1.5",				NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_foliagePlantRangeMult,					"10.5",				NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_foliageTreeRangeMult,					"32.0",				NULL, CVAR_ARCHIVE)
XCVAR_DEF(cg_foliageModelWidth,						"164.0",			NULL, CVAR_ARCHIVE)
