...
//[/SaberSys]
	...
	// New Stance
	ENUM2STRING(TRIPLE3_BLUESTANCE),
	ENUM2STRING(TRIPLE3_YELLOWSTANCE),
	ENUM2STRING(TRIPLE3_REDSTANCE),
	ENUM2STRING(TRIPLE3_DUALSSTANCE),
	ENUM2STRING(TRIPLE3_STAFFSTANCE),
	...
	ENUM2STRING(BOTH_THROWPUNCH),
	ENUM2STRING(MELEE_BLOCK_BL),
	ENUM2STRING(MELEE_BLOCK_BLASTER_L),
	ENUM2STRING(MELEE_BLOCK_BLASTER_R),
	ENUM2STRING(MELEE_BLOCK_BR),
	ENUM2STRING(MELEE_BLOCK_LT),
	ENUM2STRING(MELEE_BLOCK_RT),
	ENUM2STRING(MELEE_BLOCK_T),
	ENUM2STRING(BOTH_PUNCH3),
	ENUM2STRING(BOTH_PUNCH3TOMELEE),
	ENUM2STRING(BOTH_PUNCH4),
	ENUM2STRING(BOTH_PUNCH4TOMELEE),
	ENUM2STRING(BOTH_KICKFINISHER),
	...
	ENUM2STRING(BOTH_WOOKGETUP),

	//Spy anim, not used at all yet might be cool to use later on
	ENUM2STRING(SPY_CLIMB),
	ENUM2STRING(SPY_GETUP),
	ENUM2STRING(SPY_KILL),
	ENUM2STRING(SPY_VICTIM),
	ENUM2STRING(SPY_VICTIMDEAD),
	ENUM2STRING(SPY_STAB),
	ENUM2STRING(SPY_STABBED),
	ENUM2STRING(SPY_SLICE),
	ENUM2STRING(SPY_SLICED),
	ENUM2STRING(SPY_SLIDE),
	ENUM2STRING(SPY_SPRINT),

	//New Fire and idle anim
	ENUM2STRING(HEROPISTOLFIRE),
	ENUM2STRING(HEROPISTOLIDLE),
	ENUM2STRING(BOTH_TWO_PISTOLS),
	ENUM2STRING(BOTH_ONE_PISTOL),
	...
	ENUM2STRING(TORSO_CLONEPISTOL),
	ENUM2STRING(TORSO_CLONEPISTOLFIRE),
