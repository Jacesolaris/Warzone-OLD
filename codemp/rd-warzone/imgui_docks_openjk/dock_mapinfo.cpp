...
void DockMapInfo::imgui() {
	...
	if (ImGui::CollapsingHeader("Fog")) {
		...
		ImGui::DragFloat("FOG_VOLUMETRIC_SUN_PENETRATION", &FOG_VOLUMETRIC_SUN_PENETRATION);
		ImGui::DragFloat("FOG_VOLUMETRIC_ALPHA", &FOG_VOLUMETRIC_ALPHA);
		...
		ImGui::DragFloat("FOG_VOLUMETRIC_ALTITUDE_BOTTOM", &FOG_VOLUMETRIC_ALTITUDE_BOTTOM);
		ImGui::DragFloat("FOG_VOLUMETRIC_ALTITUDE_TOP", &FOG_VOLUMETRIC_ALTITUDE_TOP);
		ImGui::DragFloat("FOG_VOLUMETRIC_ALTITUDE_FADE", &FOG_VOLUMETRIC_ALTITUDE_FADE);
