...
void R_Register( void )
{
	...
	r_proceduralSunScale = ri->Cvar_Get("r_proceduralSunScale", "1.75"/*"3.5"*/, CVAR_ARCHIVE);
	...
	r_shadowQuality = ri->Cvar_Get("r_shadowQuality", "1", CVAR_ARCHIVE);
	...
	r_bloomRaysStrength = ri->Cvar_Get("r_bloomRaysStrength", "0.5", CVAR_ARCHIVE);
