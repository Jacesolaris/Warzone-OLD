...
gfx/effects/alpha_puffer
{
	qer_editorimage	gfx/effects/alpha_puffer
	surfaceparm	trans
	q3map_onlyvertexlighting
	cull	twosided
    {
        map gfx/effects/alpha_puffer
        blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
        rgbGen vertex
    }
}
...
gfx/flames/fireparticle
{
	cull	twosided
    {
        map gfx/flames/fireparticle
        blendFunc GL_ONE GL_ONE
        glow
        rgbGen vertex
    }
